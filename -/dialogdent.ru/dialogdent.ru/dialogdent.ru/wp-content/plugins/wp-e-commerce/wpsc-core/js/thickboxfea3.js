...
function TB_show(caption, url, rel) {
	...
	if ( baseURL.match(imageURL) ) {
      ...
      if(imageGroup.length > 1) { 
       ...
       jQuery("#TB_window").append("<div id='TB_Header'><div id='TB_TopCloseAjaxWindow'><a href='#' id='TB_TopCloseWindowButton' title='Закрыть'></a></div>"+imageTitle+"</div>");
        ...
        jQuery("#TB_TopCloseWindowButton").click(TB_remove);
          ...
          TB_HEIGHT = imageHeight + 60;
			...
			jQuery("#TB_window").append("<a href='' id='TB_ImageOff' title='Закрыть'><img id='TB_Image' src='"+url+"' width='"+imageWidth+"' height='"+imageHeight+"' alt='"+caption+"'/></a>" + "<div id='TB_caption'>"+caption+"<div id='TB_secondLine'>" + imageCount + prev.html + next.html + "</div></div><div id='TB_closeWindow'><a href='#' id='TB_closeWindowButton' title='Закрыть'></a></div>");
